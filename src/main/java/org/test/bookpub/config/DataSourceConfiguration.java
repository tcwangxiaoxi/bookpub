package org.test.bookpub.config;
...
@Configuration
@ConditionalOnProperty(name = "spring.jpa.database-platform", havingValue = "org.hibernate.dialect.MySQLDialect")
public class DataSourceConfiguration implements EnvironmentAware {
	...
	public DataSource dataSource() {
		...
		// 编码
		config.addDataSourceProperty("useUnicode", propertyResolver.getProperty("useUnicode"));
		config.addDataSourceProperty("characterEncoding", propertyResolver.getProperty("charaterEncoding"));
